<script lang="ts">
  ...
  import { esCiudadAutonoma, etiquetaDeClase, type ClaseDelMapa, type ContextoGeografico } from '../catalogo/catalogo'
  ...
  // Con Rótulos a la vista solo se toca lo rotulado: un cauce sin Rótulo no le quita el toque a la
  // mancha rotulada que tiene debajo.
