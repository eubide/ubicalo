...
- Cada sierra y cada pico lleva su cordillera en el dato; Jerarquía y Alturas se derivan de ahí sin geometría propia.
- Meseta, depresiones y relieve de Aragón quedan en la capa pero no se cargan; serían tipos nuevos con su propia decisión.
